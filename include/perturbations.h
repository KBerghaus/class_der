...
struct perturbations
{
  ...
  short has_source_delta_da_dr; /**< do we need source for delta of DE dark radiation? */
  ...
  short has_source_theta_da_dr; /**< do we need source for theta of DE dark radiation */
  ...
  int index_tp_delta_da_dr;/**< index value for delta of DE dark radiation */
  ...
  int index_tp_theta_da_dr; /**< index value for theta of DE dark radiation */
...
struct perturbations_vector
{
  ...
  int index_pt_delta_da_dr;  /**< DE dr density */
  int index_pt_theta_da_dr;  /**< DE dr velocity */
